//! USB device support for Daisy applications.

pub mod audio;
pub mod midi;

pub use embassy_usb::driver::{Driver as UsbDriver, EndpointError};
...
bind_interrupts!(struct Irqs {
    OTG_FS => audio::IsochronousInterruptObserver, usb::InterruptHandler<peripherals::USB_OTG_FS>, audio::IsochronousInterruptAcknowledger;
});
