...
5. Optional antialiased nonlinearity from plan 08.
6. Optional variation from plan 09.
...
antialiasing strategies in plan 08. Do not let a nonlinear stage compensate for
...
- Target preparation: plans/analog-osc/03-reference-capture-and-identification.md
- Baseline oscillator and BLEP: synth-core/src/dsp/analog_oscillator.rs and
  synth-core/src/dsp/blep.rs
- Nonlinear extension: plans/analog-osc/08-antialiased-nonlinearity.md
