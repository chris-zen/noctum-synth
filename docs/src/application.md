...
app imports Layer A; Layer B, sequencer, arpeggiator, unison, glide-mode, and
global-setting entries are ignored because this app does not currently
implement those Rev2 systems.
