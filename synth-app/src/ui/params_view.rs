...
use synth_core::{
    ...
    dsp::{
        ...
        envelope::{
            ...
            DEFAULT_SUSTAIN_LEVEL, MIN_TIME_SECONDS,
        },
    },
    glide_seconds,
    midi::{
        clock::MidiClockMode,
        prophet::{
            ENVELOPE_ATTACK_DECAY_MAX_SECONDS, ENVELOPE_RELEASE_MAX_SECONDS, filter_cutoff_max_hz,
        },
    },
};
            ...
            .show(ui, |ui| {
                ...
                control_cell(ui, |ui| {
                    param_knob_f32(
                        ...
                        MIN_TIME_SECONDS..=ENVELOPE_ATTACK_DECAY_MAX_SECONDS,
                ...
                control_cell(ui, |ui| {
                    param_knob_f32(
                        ...
                        MIN_TIME_SECONDS..=ENVELOPE_RELEASE_MAX_SECONDS,
