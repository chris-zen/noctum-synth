...
- [Model Lineup](models/overview.md)
...
- [Capabilities](synthesizer/overview.md)
...
- [Control and Rendering](sdk/control-and-rendering.md)
- [Engine Architecture](sdk/engine-architecture.md)
- [Development Workflow](sdk/development.md)

# Hardware

- [Platform Overview](hardware/overview.md)
- [Daisy Seed](hardware/daisy.md)
